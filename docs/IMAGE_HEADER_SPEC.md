...
|---|---|---|---|---|
| `"J5AA"` (4A 35 41 41) | **J5AA v1 统一头** | 48B | 新（本规范） | 上位机自述解析 + 完整性（hcrc/payload_crc） |
| `"FIRM"` (46 49 52 4D) | W515 旧元数据 | 40B | 保留不动 | **W515 Boot 三连校验事实源**（WB:1210-1252） |
| `"N3MT"` (4E 33 4D 54) | N32 旧元数据 | 32B | 保留过渡 | **N32 0x3A 上报事实源**（Boot main.c:1214-1249） |
